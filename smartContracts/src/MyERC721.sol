...
contract MyERC721 is ERC721 {
    ...
    function mint(address to, string memory _imagURI) public {
     ...
     *
     */
    function transferToken(address from, address _winner, uint256 tokenId) public {
        ...
        _safeTransfer(from, _winner, tokenId, "");
    }
